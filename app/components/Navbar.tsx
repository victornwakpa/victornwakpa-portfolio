...
export default function Navbar() {
  return (
    <div>
      <header className="md:visible invisible fixed top-0 z-10 flex items-center justify-center w-full mx-auto mt-2">
        <nav
          className={`
      w-2/4 h-full
    ...
    `}
        >
          {navItems.map((link) => (
            <a
              className="hover:bg-white/10 p-1 rounded-full px-2 sm:px-3 transition ease-in text-sm sm:text-base capitalize"
